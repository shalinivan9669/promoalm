...
const SUPPORT_COPY: Record<SupportIntent, SupportPageCopy> = {
  "faq-hub": {
    ...
    relatedLinksDescription: "Если ответ не закрыт до конца, вот страницы, где есть продолжение маршрута.",
  ...
  delivery: {
    ...
    relatedLinksDescription: "Сюда логично идти после понимания логистики и монтажа.",
  ...
  payment: {
    ...
    relatedLinksDescription: "Полезные страницы, если нужно сверить доставку, контакты или сетевой формат.",
