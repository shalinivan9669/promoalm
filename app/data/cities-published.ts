...
export const publishedCitiesData: CityPageData[] = [
  {
    ...
    hero: {
      ...
      description:
        "По Алматы берём проекты, где важны читаемость фасада, быстрый запуск точки и аккуратный монтаж без лишней пересборки решения.",
  ...
  },
  {
    ...
    hero: {
      ...
      description:
        "По Астане чаще считаем проекты, где важны высота, масштаб объекта, конструктив и заметность с дистанции.",
  ...
  },
  {
    ...
    hero: {
      ...
      title: "В Шымкенте вывеску можно быстро запустить, если сразу собрать объект, макет и маршрут производства в один понятный процесс",
      description:
        "По Шымкенту удобно запускать проекты, где важны быстрый расчёт, понятный маршрут согласования и аккуратная отгрузка без затянутого старта.",
