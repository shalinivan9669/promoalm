...
export const publishedCitiesData: CityPageData[] = [
  {
    ...
    status: "published",
    city: "Алматы",
    h1: "Вывеска должна читаться в потоке улицы",
    meta: {
    ...
    hero: {
      ...
      title: "Вывеска должна читаться в потоке улицы",
      description:
        "Смотрим на фасад, соседние вывески и реальную дистанцию чтения, чтобы объект не терялся в городской среде.",
  ...
  },
  {
    ...
    status: "published",
    city: "Астана",
    h1: "Вывеска должна держать дистанцию",
    meta: {
    ...
    hero: {
      ...
      title: "Вывеска должна держать дистанцию",
      description:
        "В Астане особенно важны высота, конструктив и читаемость издалека, чтобы объект работал на масштабе, а не спорил с ним.",
  ...
  },
  {
    ...
    status: "published",
    city: "Шымкент",
    h1: "Быстрый запуск вывески без лишних пересборок",
    meta: {
    ...
    hero: {
      ...
      title: "Быстрый запуск вывески без лишних пересборок",
      description:
        "Собираем вводные быстро, показываем макет и сразу переводим задачу в производство без затянутого цикла.",
