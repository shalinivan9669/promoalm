...
const serviceSummaries: ServiceSummary[] = [
  ...
  },
  {
    ...
    intro:
      "Для ресепшен-зон, торговых точек, офисов, шоурумов и внутренних брендовых носителей. Используются там, где важно поддержать бренд внутри пространства, а не только собрать фасадную заметность снаружи.",
