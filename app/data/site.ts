...
export const homePageData: HomePageData = {
  hero: {
    ...
    note: "Интерьерный неон делаем для коммерческих помещений. Для улицы считаем отдельные наружные решения. Вы присылаете фото, размеры и задачу. Дальше уже можно быстро перейти к расчёту и понятному маршруту запуска."
  },
  intro:
    "Вывеска должна  выглядеть {к} и работать {приностить деньги}: читаться с улицы, попадать в формат объекта и не разваливаться на согласовании.",
  ...
  deliveryHighlights: [
    "Согласование начинается с исходных данных — чем лучше видно объект и размеры, тем меньше пустых кругов в переписке.",
    "Логистика обсуждается отдельно по задаче — у разных объектов и городов разная сложность запуска.",
    "Монтаж — отдельный рабочий слой: по нему важны адрес, доступ, формат точки и технические ограничения на месте."
  ],
  finalCta: {
