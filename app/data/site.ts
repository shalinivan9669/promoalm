...
export const homePageData: HomePageData = {
  hero: {
    ...
    title: "Вывески для бизнеса без хаоса",
    description:
...
export const aboutPageData: AboutPageData = {
  hero: {
    ...
    description:
      "Сильнее всего мы работаем там, где нужен контролируемый результат: фасады, световые конструкции, повторяемое качество для нескольких точек и понятная логистика по Казахстану.",
